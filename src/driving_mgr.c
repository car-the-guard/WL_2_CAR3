...
void *thread_driving_manager(void *arg) {
    ...
    while (g_keep_running) {
        ...
        // wl4->heading 대신 헬퍼 함수 wl4_get_direction(*wl4) 사용
        ...
        // 출력부에서도 헬퍼 함수를 사용하여 비트 데이터를 파싱.
        //printf("\x1b[32m[T5-DRIVING] LAT:%.6f, HDG:%u, ALT:%d\x1b[0m\n", 
               //gps.lat, wl4_get_direction(*wl4), gps.alt);
